...
<!--  <van-button class="add-button" type="primary" icon="success" style="z-index: 999;" @click="toAddTag"/>-->
  ...
  <br>
  <br>
  <van-button type="primary" block @click="toAddTag" size="large">提交</van-button>
